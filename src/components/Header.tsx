...
const Header = () => {
  ...
  return (
    <div className="mt-5 px-2 py-3 w-[50%] flex justify-center text-white text-center fixed bg-gray-500/10 top-0 z-50  rounded-full border-orange-800/10 left-1/2 -translate-x-1/2 backdrop-blur-xl shadow-md shadow-orange-900/50">
